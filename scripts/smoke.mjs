...
try {
  ...
  expect(config.routes.length === 61 && config.apiRoutes.length >= 185 && config.apiRoutes.includes('/api/v1/public/markets/overview'), 'route inventory invalid');
