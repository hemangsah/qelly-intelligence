...
ROOT=pathlib.Path(__file__).resolve().parents[1]; OUT=ROOT/'preview'/'qelly-all-screens'
...
sheet_path=ROOT/'preview'/'QELLY_ALL_IMPLEMENTED_SCREENS_CONTACT_SHEET.jpg';sheet.save(sheet_path,quality=90)
