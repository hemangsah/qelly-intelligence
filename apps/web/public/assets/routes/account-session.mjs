...
export async function renderAccountSession(main,{api,pageHead,escapeHtml,toast,onLoggedOut,onAuthenticated}){
  ...
  main.innerHTML=`<section class="q-page q-v6-account-page">
    ...
    <div class="q-v6-profile-layout">
      <section class="q-panel"><div class="q-panel-head"><div><h2>Profile preferences</h2><p>Persisted to the authenticated RLS profile, not browser-only storage.</p></div><span class="q-status q-status--live">CLOUD</span></div><form id="v6-profile-form" class="q-panel-body q-v6-profile-form">
        ...
        <label class="q-v6-cloud-toggle q-setting--wide"><input type="checkbox" name="cloudSyncOptIn" ${settings.cloudSyncOptIn?'checked':''}><span><strong>Cloud synchronization</strong><small>Allow saved deterministic calculations and supported workspace state to synchronize through the authenticated Qelly cloud contract.</small></span></label>
