...
const candidatePaths=[
  ...
  new URL('../apps/web/public/assets/qelly-v53-lock-shell.mjs',import.meta.url)
];
...
test('V5.3 family harmonization no longer activates the historical synthetic candidate runtime',async()=>{
  ...
  assert.doesNotMatch(source,/qelly-v53-lock-shell\.mjs/);
...
test('historical synthetic lock assets are absent from the public tree',async()=>{
