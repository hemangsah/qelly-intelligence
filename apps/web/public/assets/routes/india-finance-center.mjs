...
export async function renderIndiaFinanceCenter(main,{pageHead,escapeHtml,toast}){
  ...
  main.innerHTML=`<section class="q-page q-india-finance-page">
    ...
    <div class="q-india-grid">
      ...
      <section class="q-panel q-india-market-pulse">
        ...
        <div class="q-panel-body"><div class="q-india-live-grid"><div><h3>India market movers</h3><div class="q-india-widget q-india-widget--screener" data-india-screener></div></div><div><h3>Benchmarks & rupee</h3><p class="q-india-benchmark-coverage"><strong>Coverage:</strong> Nifty 50 · Sensex · Bank Nifty · India VIX · USD/INR · Gold</p><div class="q-india-widget" data-india-quotes></div></div></div><div class="q-india-context-grid"><div><h3>India economic calendar</h3><div class="q-india-widget q-india-widget--calendar" data-india-calendar></div></div><div><h3>Nifty technical context</h3><div class="q-india-widget q-india-widget--technical" data-india-technicals></div></div></div><div><h3>India market headlines</h3><div class="q-india-widget q-india-widget--stories" data-india-stories></div></div><div class="q-india-source-boundary"><strong>Primary-source boundary</strong><p>Direct QELLY feeds for FII/DII flows, government-bond yields, market breadth and corporate actions are not licensed or connected here. Use the official source destinations below; QELLY does not substitute scraped values.</p></div><div class="q-actions"><a class="q-button q-button--secondary" href="https://www.nseindia.com/market-data/live-equity-market" target="_blank" rel="noopener noreferrer nofollow">NSE market data ↗</a><a class="q-button q-button--secondary" href="https://www.nseindia.com/reports/fii-dii" target="_blank" rel="noopener noreferrer nofollow">NSE FII/DII ↗</a><a class="q-button q-button--secondary" href="https://www.nseindia.com/companies-listing/corporate-filings-actions" target="_blank" rel="noopener noreferrer nofollow">NSE corporate actions ↗</a><a class="q-button q-button--secondary" href="https://www.bseindia.com/markets.html" target="_blank" rel="noopener noreferrer nofollow">BSE markets ↗</a><a class="q-button q-button--secondary" href="https://www.rbi.org.in/" target="_blank" rel="noopener noreferrer nofollow">RBI rates &amp; G-Sec ↗</a><a class="q-button q-button--secondary" href="https://www.sebi.gov.in/" target="_blank" rel="noopener noreferrer nofollow">SEBI ↗</a></div></div>
      </section>
  ...
  const indiaWidgets=[
    ...
    mountLazyTradingViewWidget(main.querySelector('[data-india-quotes]'),{kind:'marketQuotes',label:'India benchmarks and rupee',openUrl:'https://www.tradingview.com/markets/indices/quotes-india/',config:{...shared,symbolsGroups:[{name:'India',symbols:[{name:'NSE:NIFTY',displayName:'Nifty 50'},{name:'BSE:SENSEX',displayName:'Sensex'},{name:'NSE:BANKNIFTY',displayName:'Bank Nifty'},{name:'NSE:INDIAVIX',displayName:'India VIX'},{name:'FX_IDC:USDINR',displayName:'USD / INR'},{name:'MCX:GOLD1!',displayName:'Gold'}]}],showSymbolLogo:true}},{rootMargin:'260px 0px'}),
    mountLazyTradingViewWidget(main.querySelector('[data-india-calendar]'),{kind:'economicCalendar',label:'India economic calendar',openUrl:'https://www.tradingview.com/economic-calendar/',config:{...shared,countryFilter:'in',importanceFilter:'0,1'}},{rootMargin:'220px 0px'}),
    mountLazyTradingViewWidget(main.querySelector('[data-india-technicals]'),{kind:'technicalAnalysis',label:'Nifty 50 technical context',openUrl:'https://www.tradingview.com/symbols/NSE-NIFTY/technicals/',config:{...shared,symbol:'NSE:NIFTY',interval:'1D',displayMode:'single',showIntervalTabs:true}},{rootMargin:'220px 0px'}),
