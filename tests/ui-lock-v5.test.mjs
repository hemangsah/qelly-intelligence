...
test('Global Market Network succeeds the V5 Live Market Command with truthful evidence and no-fabrication semantics',async()=>{
  ...
  for(const phrase of ['Data reliability','Synthetic market values','Trading execution','Source details','ECB governed FX reference','Official research network','TradingView is an external display boundary'])assert.ok(route.includes(phrase),`missing Global Market Network contract: ${phrase}`);
