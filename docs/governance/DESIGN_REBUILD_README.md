...
- Burgundy ink `#180008`
- Burgundy core `#310011`
- Burgundy signal `#5B0828`
- Burgundy bloom `#8E1D4B`
- Porcelain analytical surfaces
- Rounded geometric display typography
- Asymmetric soft-corner modules

## Interaction language

- Progressive hierarchy reveal
- Magnetic and ripple response on primary actions
- Bounded card tilt and pointer glow
- Route transitions and contextual drawer motion
- Candle/line animation
- Hover elevation, border emphasis and control shimmer
- Reduced-motion-safe equivalents
...
- Route 71 (`#/qelly-verify`) is recorded in `design/inventory/QELLY_ROUTE_INVENTORY_V54_DELTA.csv` as a canonical reconciliation of an existing evidence surface
