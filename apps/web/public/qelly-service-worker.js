...
const SHELL=['./','./index.html','./qelly-release.json','./qelly-config.js','./manifest.webmanifest','./favicon.svg','./assets/tokens.css','./assets/app.css','./assets/qelly-premium-reset.css','./assets/qelly-worldclass-uiux.css','./assets/qelly-verify.css','./assets/qelly-verify-evidence.css','./assets/qelly-verify-bootstrap.mjs','./assets/qelly-verify-engine.mjs','./assets/qelly-verify-methodology.mjs','./assets/qelly-verify-report.mjs','./assets/qelly-verify-product.mjs','./assets/qelly-public-runtime.css','./assets/qelly-public-runtime.mjs','./assets/qelly-production-shell.css','./assets/qelly-modern-interaction-polish.css','./assets/qelly-premium-theme.css','./assets/qelly-product-experience.css','./assets/qelly-navigation-v2.css','./assets/about-qelly-v2.css','./assets/routes/market-network-v2.css','./assets/routes/discovery-overview.css','./assets/routes/discovery-overview.mjs','./assets/qelly-premium-interactions.mjs','./assets/qelly-product-experience.mjs','./assets/qelly-production-shell.mjs','./assets/app.js','./assets/calculation/formula-engine.mjs','./assets/calculation/indicator-engine.mjs','./legal/beta.html','./legal/risk.html','./legal/privacy.html','./legal/terms.html','./support.html'];
