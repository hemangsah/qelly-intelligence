...
const FALLBACK_CACHE=`${CACHE_PREFIX}fallback-v4`;
const SHELL=['./','./index.html','./qelly-release.json','./qelly-config.js','./manifest.webmanifest','./favicon.svg','./assets/tokens.css','./assets/app.css','./assets/qelly-premium-reset.css','./assets/qelly-worldclass-uiux.css','./assets/qelly-verify.css','./assets/qelly-verify-evidence.css','./assets/qelly-verify-bootstrap.mjs','./assets/qelly-verify-engine.mjs','./assets/qelly-verify-methodology.mjs','./assets/qelly-verify-report.mjs','./assets/qelly-verify-product.mjs','./assets/prompt2c-public-beta.css','./assets/prompt2c-public-beta.mjs','./assets/qelly-production-shell.css','./assets/qelly-modern-interaction-polish.css','./assets/qelly-premium-theme.css','./assets/qelly-premium-interactions.mjs','./assets/qelly-production-shell.mjs','./assets/app.js','./assets/calculation/formula-engine.mjs','./assets/calculation/indicator-engine.mjs','./legal/beta.html','./legal/risk.html','./legal/privacy.html','./legal/terms.html','./support.html'];
