...
const MOBILE_PRESENTATION=[
  ...
  ['.q-page-head p',{'font-size':'13px','line-height':'1.5','color':'var(--q-muted)'}],
  ['.q-page-actions',{'justify-content':'flex-start','margin-top':'8px','padding':'0'}],
  ['.q-state-banner',{'grid-template-columns':'1fr','margin-bottom':'8px','min-height':'0','padding':'10px 12px'}],
  ...
  ['.q-universe-node',{'position':'relative','left':'auto','top':'auto','transform':'none','flex':'0 0 min(72vw,240px)','width':'auto','min-height':'72px','margin':'0','scroll-snap-align':'start'}],
  ['.q-universe-node span',{'font-size':'12px','line-height':'1.35'}],
  ...
  ['.q-universe-cluster>header>div>span',{'font-size':'12px'}],
  ['.q-universe-cluster .q-icon-button',{'font-size':'18px'}],
  ...
  ['.q-universe-route-grid button>span,.q-universe-route-grid button>small',{'font-size':'12px','line-height':'1.35'}],
  ...
  ['.q-capability-ribbon .q-panel-body>div>span',{'font-size':'12px'}],
  ['.q-capability-ribbon .q-panel-body>div>strong',{'font-size':'13px','line-height':'1.4'}]
];
