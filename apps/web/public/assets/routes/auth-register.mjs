...
if(!emailDelivery){
  main.innerHTML=`<section class="q-auth-page" data-production-auth="unavailable"><div class="q-auth-hero"><div><p class="q-eyebrow">Qelly account</p><h1>Account creation is not open yet.</h1><p>Qelly is currently accepting sign-ins for existing accounts. You can use markets, research and calculation tools without creating an account.</p></div></div><div class="q-auth-card"><div><p class="q-eyebrow">Existing member</p><h2>Continue to your workspace</h2><p class="q-muted-copy">Sign in with the email and password already associated with your Qelly workspace.</p></div><div class="q-auth-footer"><button class="q-button q-button--primary" type="button" data-login>Sign in</button><button class="q-button q-button--ghost" type="button" data-home>Return home</button></div></div></section>`;
  ...
  main.innerHTML=`<section class="q-auth-page" data-production-auth="true">
    <div class="q-auth-hero"><div><p class="q-eyebrow">Create an account</p><h1>Save your Qelly work securely.</h1><p>Create a private workspace for saved calculations, revision history and optional cloud synchronization. Markets and tools remain available without registration.</p></div><ol class="q-auth-steps"><li><b>1</b><span>Create account</span></li><li><b>2</b><span>Confirm email</span></li><li><b>3</b><span>Open workspace</span></li></ol></div>
