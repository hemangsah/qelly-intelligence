...
THEMES=[
 ('burgundy-command','Sovereign Burgundy'),('burgundy-night','Burgundy Nocturne'),('porcelain-burgundy','Porcelain Atelier'),('graphite-terminal','Graphite Reserve'),('midnight-research','Midnight Merlot'),('high-contrast','High Contrast')
]
