...
export const unavailableCapabilities=Object.freeze([
  ...
  capability('asset-intelligence','Protected asset intelligence datasets','market-intelligence','high',['asset-intelligence/**','discovery/asset-intelligence','discovery/advanced-chart','discovery/fundamentals-estimates','discovery/filing-workspace','discovery/event-calendar'],'The protected legacy chart, filing, fundamental and event fixture APIs remain unpromoted; provider-rights-safe public diligence, technical-study, fundamentals-model, filing-citation and event-planning contracts are available.',['discovery/asset-intelligence','discovery/advanced-chart','discovery/fundamentals-estimates','discovery/filing-workspace','discovery/event-calendar']),
