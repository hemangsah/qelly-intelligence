...
export const unavailableCapabilities=Object.freeze([
  ...
  capability('alerts-notifications','Alerts & notifications','operations','medium',['alerts/**','notifications/**','notification-schedules/**','discovery/alert-rules'],'Persistent alert evaluation and notification delivery require a production worker/scheduler and storage contract that is not yet enabled. A public deterministic alert-rule design and dry-run contract is available without persistence or delivery.',['discovery/alert-rules']),
