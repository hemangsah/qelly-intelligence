...
test('public recovery is route-owned and no longer globally rewrites main',async()=>{
  ...
  assert.match(source,/personalized recommendation/i);
...
test('decision preview recovery remains fail-closed without manufacturing a substitute trade view',async()=>{
