...
The 431-frame matrix in `design/inventory/QELLY_SCREEN_MATRIX.csv` supplies desktop/mobile route coverage, selected persona variants, states, and overlays. Browser/device verification remains a release gate.
