...
const SHELL=['./','./index.html','./qelly-release.json','./qelly-config.js','./manifest.webmanifest','./favicon.svg','./assets/tokens.css','./assets/app.css','./assets/qelly-premium-reset.css','./assets/qelly-worldclass-uiux.css','./assets/qelly-verify.css','./assets/qelly-verify-engine.mjs','./assets/qelly-verify-product.mjs','./assets/prompt2c-public-beta.css','./assets/prompt2c-public-beta.mjs','./assets/app.js','./assets/calculation/formula-engine.mjs','./assets/calculation/indicator-engine.mjs','./legal/beta.html','./legal/risk.html','./legal/privacy.html','./legal/terms.html','./support.html'];
