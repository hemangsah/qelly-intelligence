...
try {
  ...
  expect(config.routes.length === 71 && config.apiRoutes.length === 209 && config.apiRoutes.includes('/api/v1/public/markets/overview'), 'route inventory invalid');
  ...
  const getPaths = [
    ...
    '/api/v1/audit','/api/v1/audit/verify','/','/qelly-config.js','/assets/tokens.css','/assets/app.css','/assets/app.js','/assets/routes/comparison-lab-v2.css','/assets/routes/alert-rules-v2.css',
