  ...
  main.innerHTML=`<section class="q-page">${stateBanner()}
    ...
    <div class="q-dashboard-grid">
      ...
      <div class="q-dashboard-stack">
        ...
        <section class="q-panel"><div class="q-panel-head"><div><h2>Continue analysis</h2><p>Move from the snapshot into quantitative evidence, catalysts and scheduled events.</p></div></div><div class="q-panel-body"><div class="q-action-row"><button class="q-button q-button--primary" data-action="asset-decision">Decision Intelligence</button><button class="q-button" data-action="asset-formula">Formula Evidence</button><button class="q-button" data-action="asset-intelligence">Asset Intelligence</button><button class="q-button" data-action="asset-news">Qelly Chat</button><button class="q-button" data-action="asset-events">Events</button></div><p class="q-muted-copy">Research flow: dossier → Decision Intelligence → formula evidence → Qelly Chat. Asset context is preserved in-session; each surface remains independently evidence-gated.</p></div></section>
      </div>
    </div>
  </section>`;
