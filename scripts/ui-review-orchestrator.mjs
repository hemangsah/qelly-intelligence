...
const authoritativePasses=['scripts/ui-review-premium.mjs','scripts/ui-review-premium-evidence.mjs','scripts/ui-review-persona-clean.mjs','scripts/font-comparison-board-local.mjs','scripts/ui-review-font-surface-stable.mjs'];
...
const fontSurface=fontBoard.code===0?await run('scripts/ui-review-font-surface-stable.mjs'):{script:'scripts/ui-review-font-surface-stable.mjs',code:1,signal:null,skipped:true};
