...
test('advanced decision metrics stay finite and expose independent volatility estimators',()=>{
  ...
  for(const key of ['garmanKlassVolatilityPct','rogersSatchellVolatilityPct','efficiencyRatio','roc14Pct','bollingerZ20','rangePosition20Pct','volatilityPercentile','downsideDeviationPct']){
    assert.ok(metrics[key]===null||Number.isFinite(metrics[key]),key);
  }
