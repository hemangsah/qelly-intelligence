...
const routes = [
  ...
  { section:'Workspace', route:'alert-center', label:'Alert Rules', icon:icon('alert'), meta:'Public', public:true },
  { section:'Workspace', route:'notification-center', label:'Notifications', icon:icon('notification'), meta:'Public', public:true },
  { section:'Workspace', route:'screener-lab', label:'Screener Lab', icon:icon('screener'), meta:'Public', public:true },
...
const FEATURE_GUIDE=Object.freeze({
  ...
  'auth-register':{purpose:'Create your organization and first workspace.',useCase:'Use when a team is starting its Qelly operating environment.'},
  ...
  'live-markets':{purpose:'Survey cross-asset market coverage, freshness and source availability.',useCase:'Use for a fast view of approved live and reference sources.'},
  ...
  'formula-detail':{purpose:'Inspect one formula, its inputs, assumptions and deterministic method.',useCase:'Use when a specific equation needs a transparent implementation and interpretation boundary.'},
  'indicator-detail':{purpose:'Inspect one technical indicator, its parameters and calculation method.',useCase:'Use when validating how a selected indicator is computed before using it in research.'},
  'calculator-detail':{purpose:'Run one bounded calculator with explicit inputs, outputs and formula context.',useCase:'Use when a specific finance or risk calculation needs a reproducible receipt.'},
  'saved-calculation-detail':{purpose:'Inspect one preserved calculation run and its recorded inputs and outputs.',useCase:'Use when reconstructing or comparing a previously saved calculation without changing its history.'},
  'category-detail':{purpose:'Inspect one market category and the governed assets or evidence associated with it.',useCase:'Use after category discovery when the research question has narrowed to one category.'},
  'venue-detail':{purpose:'Inspect one market venue with its access, source and evidence boundaries.',useCase:'Use after venue discovery when a specific exchange or broker destination requires deeper review.'},
  'research-article':{purpose:'Read one source-aware research article with its evidence and publication context.',useCase:'Use when a research result needs focused review without losing source and methodology boundaries.'},
  ...
  'discovery-hub':{purpose:'Start broad market discovery from available market coverage.',useCase:'Use when you have a theme but not yet a specific asset.'},
  ...
  'venues':{purpose:'Compare exchange and broker destinations with clear source, access and evidence limits.',useCase:'Use when market access matters and you must separate an official destination from approved observations, display rights, account access or execution.'},
  'dex-discovery':{purpose:'Turn a protocol or liquidity-pool question into a structured on-chain evidence plan.',useCase:'Use when investigating contracts, pool mechanics, dependencies and liquidity risks without connecting a wallet or submitting a transaction.'},
  'global-charts':{purpose:'Specify and challenge a cross-market relationship before interpreting a chart.',useCase:'Use when testing whether two macro series support a thesis without confusing co-movement, causality or forecast.'},
  'converter':{purpose:'Translate one verified FX reference observation and keep declared conversion costs separate from the result.',useCase:'Use when estimating an FX translation, reconstructing its EUR cross-rate and testing your own spread or fee assumptions without requesting a quote or moving money.'},
  ...
  'trust-center':{purpose:'Understand sources, methodology, freshness and coverage limits.',useCase:'Use before trusting or redistributing a displayed observation.'},
  ...
  'advanced-chart':{purpose:'Configure one reproducible technical study and verify its historical series is fit for calculation.',useCase:'Use when a chart claim needs explicit parameters, data-quality checks, failure modes and an invalidation rule before entering a decision.'},
  ...
  'market':{purpose:'Review cross-asset market context, charts and research sources in one place.',useCase:'Use for market context, external displays and clear source limits.'},
  ...
  'alert-center':{purpose:'Turn one measurable condition into an evidence-qualified, noise-controlled and owned human review trigger.',useCase:'Use when attention should open only after a declared observation, source, freshness policy, cooldown, reset condition and reviewer all qualify—without scheduling, delivering or executing anything.'},
  'notification-center':{purpose:'Qualify one delivered item into an accountable human review.',useCase:'Use when a receipt exists to calculate urgency, group duplicates, assign ownership and record the intended response without inventing an inbox.'},
  'screener-lab':{purpose:'Compile a typed, freshness-aware screen and inspect every candidate exclusion.',useCase:'Use when a research question must become reusable criteria with explicit universe, evidence, missing-data and review policies.'},
