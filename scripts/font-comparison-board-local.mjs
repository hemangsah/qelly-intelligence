...
function page(fonts,{selected=false}={}){
  ...
  const cards=[specimen(current,{current:true}),...fonts.map((font)=>specimen(font)),...(selected?[specimen(fonts[0],{selected:true})]:[])];
...
try{
  ...
  const context=await browser.newContext({viewport:{width:2100,height:1080},colorScheme:'dark'});
