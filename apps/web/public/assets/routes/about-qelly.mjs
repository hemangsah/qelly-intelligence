...
const JOURNEY=Object.freeze([
  ...
  {step:'04',name:'Decide',purpose:'Stress the thesis and connect every judgment to its evidence.',use:'Use before a human records a considered decision.',route:'decision-provenance',action:'Open Decision'},
...
export async function renderAboutQelly(main,{pageHead,stateBanner,escapeHtml,navigate,state}){
  ...
  main.innerHTML=`<section class="q-page q-about-page q-about-v2-page">
    ...
    <section class="q-about-v2-boundary"><div><p class="q-eyebrow">What Qelly does</p><h2>Preserves the reasoning chain.</h2><ul><li>Separates observations, assumptions and derived analysis.</li><li>Shows source, freshness, confidence and coverage.</li><li>Connects research to a human-controlled decision record.</li><li>Keeps missing or restricted evidence visible.</li></ul></div><div><p class="q-eyebrow">What Qelly will not do</p><h2>Hide uncertainty behind interface theatre.</h2><ul><li>No invented fallback market values.</li><li>No hidden third-party data collection.</li><li>No personalized fiduciary claim.</li><li>No order, custody, transfer or wallet execution.</li></ul></div></section>
