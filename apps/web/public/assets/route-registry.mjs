...
const FEATURE_GUIDE=Object.freeze({
  ...
  'asset-intelligence':{purpose:'Combine identity, market and issuer evidence for one asset.',useCase:'Use when moving from discovery into asset-level diligence.'},
