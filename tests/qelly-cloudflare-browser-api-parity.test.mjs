...
const EXACT_IMPLEMENTED=new Set(['/api/v1/config','/api/v1/health','/api/v1/readiness','/api/v1/platform/readiness','/api/v1/platform/data-plane','/api/v1/platform/capabilities','/api/v1/auth/email-capability','/api/v1/auth/register','/api/v1/auth/login','/api/v1/auth/callback','/api/v1/auth/session','/api/v1/auth/status','/api/v1/auth/refresh','/api/v1/auth/logout','/api/v1/auth/recovery/request','/api/v1/auth/recovery/status','/api/v1/auth/recovery/reset','/api/v1/cloud/opt-in','/api/v1/cloud/status','/api/v1/account/delete','/api/v1/account/export','/api/v1/profile','/api/v1/providers/status','/api/v1/providers/runtime','/api/v1/public/providers','/api/v1/market/overview','/api/v1/market/network','/api/v1/decision-proven-graph','/api/v1/decision-scan','/api/v1/decision-ledger','/api/v1/intelligence/chat','/api/v1/public/markets/overview','/api/v1/public/markets/assets','/api/v1/discovery/asset-intelligence','/api/v1/discovery/advanced-chart','/api/v1/session/context','/api/v1/preferences/layout','/api/v1/sessions','/api/v1/sync/push','/api/v1/sync/pull','/api/v1/saved-calculations','/api/v1/feedback','/api/v1/live-markets/catalog','/api/v1/live-markets/status','/api/v1/live-markets/candles','/api/v1/live-markets/ticker','/api/v1/research/workspaces','/api/v1/workspace/watchlists','/api/v1/portfolio/overview','/api/v1/portfolio/holdings','/api/v1/portfolio/performance','/api/v1/portfolio/risk','/api/v1/portfolio/attribution','/api/v1/evidence/graphs','/api/v1/evidence/explain-move','/api/v1/instruments/search','/api/v1/instruments/summary','/api/v1/instruments/resolve','/api/v1/data-quality/status','/api/v1/data-quality/events','/api/v1/data-quality/incidents','/api/v1/data-quality/providers','/api/v1/contracts/entitlements','/api/v1/entitlements/evaluate','/api/v1/timeseries/summary']);
...
function cloudflareImplementationState(apiPath){
 ...
 if(/^\/api\/v1\/decision-ledger\/[^/]+(?:\/observe)?$/.test(apiPath))return 'implemented';
 if(/^\/api\/v1\/evidence\/graphs\/[^/]+(?:\/(?:traverse|export))?$/.test(apiPath))return 'implemented';
