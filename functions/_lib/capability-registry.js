...
export const unavailableCapabilities=Object.freeze([
  ...
  capability('asset-intelligence','Protected asset intelligence datasets','market-intelligence','high',['asset-intelligence/**','discovery/asset-intelligence','discovery/advanced-chart','discovery/fundamentals-estimates'],'The protected legacy chart, filing and fundamental fixture APIs remain unpromoted; provider-rights-safe public diligence, technical-study and fundamentals-model planning contracts are available.',['discovery/asset-intelligence','discovery/advanced-chart','discovery/fundamentals-estimates']),
  ...
  capability('discovery','Additional discovery intelligence','discovery','high',['discovery/**'],'Selected provider-rights-safe discovery contracts are promoted; local fixture and persistence surfaces remain unavailable.',['discovery/asset-intelligence','discovery/advanced-chart','discovery/fundamentals-estimates']),
